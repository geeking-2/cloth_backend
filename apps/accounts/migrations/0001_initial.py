    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('venue', 'Venue'), ('creator', 'Creator')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialty', models.CharField(choices=[('vr', 'Virtual Reality'), ('ar', 'Augmented Reality'), ('mr', 'Mixed Reality'), ('immersive', 'Immersive Installation'), ('projection', 'Projection Mapping'), ('interactive', 'Interactive Art'), ('other', 'Other')], default='immersive', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_type', models.CharField(choices=[('museum', 'Museum'), ('gallery', 'Gallery'), ('cultural_house', 'Cultural House'), ('theater', 'Theater'), ('studio', 'Studio'), ('other', 'Other')], default='gallery', max_length=20)),
